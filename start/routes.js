...
Route.get('countries/:id/states/:code/cities', 'StateController.cities').as('countries.states.cities');
...
Route.get('provinces/:provId/cities', 'ProvinceController.cities').as('provinces.cities.index');